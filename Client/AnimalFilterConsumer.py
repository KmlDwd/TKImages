...
from AnimalFilter.AnimalFilter import process_request
from Utils.Utils import setup_health_consumer

logger = logging.getLogger("AnimalFilterConsumer")
...
SERVICE_NAME = "animal_service"

if __name__ == '__main__':
    logger.info("Starting AnimalFilterConsumer")
    consumer = RabbitMQSyncConsumer.from_config('animal')
    producer = RabbitMQProducer.from_config()
    health_consumer = RabbitMQAsyncConsumer.from_config('health')
    logger.info("AnimalFilterConsumer started successfully")
